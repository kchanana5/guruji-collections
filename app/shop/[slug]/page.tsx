      ...
      <header className="border-b border-[var(--border)] bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-5 sm:py-5 lg:px-8">
          <Link href="/" className="flex shrink-0 items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--brand)] text-xs font-bold tracking-widest text-white sm:h-11 sm:w-11 sm:text-sm">GJC</span>
            <span className="hidden text-sm font-bold tracking-[0.25em] sm:block">GURUJI</span>
          </Link>
